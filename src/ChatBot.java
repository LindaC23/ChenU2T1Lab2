public class ChatBot {
    ...
    // method that prints a message about friends
    public void friends() {
        System.out.println("I have made countless good friends as a chat bot!");
        System.out.println("Maybe you'll even be my next one? :D");
    }

    // method that multiplies and returns the product of two numbers
